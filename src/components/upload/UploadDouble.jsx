            ...
            >
                ...
                <CardActions className="md-full-width">
                    ...
                    <FileUpload
                        ...
                        label="Choose training log file"
                        required
                        accept=".xes, .xes.gz"
                ...
                <CardActions className="md-full-width">
                    ...
                    <FileUpload
                        ...
                        label="Choose validation log file"
                        required
                        accept=".xes, .xes.gz"
                ...
                <CardActions className="md-full-width">
                    ...
                    <Button type="submit" flat primary
                            disabled={!(fileNameTest && fileNameTraining) || sending}>Submit</Button>
                </CardActions>
