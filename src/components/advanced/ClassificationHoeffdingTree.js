...
const ClassificationHoeffdingTree = (props) => {
    const methodConfig = `${CLASSIFICATION}.${HOEFFDING_TREE}`;
...
ClassificationHoeffdingTree.propTypes = {
    onChange: PropTypes.func.isRequired
};
export default ClassificationHoeffdingTree;
