...
import ConfigTableCard from '../../views/Explanation/Explanation';
// import ConfigTableCard from '../../views/Explanation/Explanation'; TODO ADD this
...
const ExplanationHeaderCard = (props) => {
  ...
  return <Card className="md-block-centered">
    ...
    <CardText>
      ...
      {/*<ConfigTableCard jobs={props.jobs} predictionMethod={props.predictionMethod}/>*/}
